...
const Discovery = () => {
    return (
        <div className={styles.main}>
            <div className={styles.first}>Discovering India's diverse landscapes, one scenic road trip at a time</div>
            <div className={styles.second}>
                <ul>
                    <li className={styles.secA}>Experience the thrill of road travel with our reliable car rental and taxi service as we explore the diverse landscapes of India together. We're passionate about making car hire accessible and enjoyable for everyone.</li>

                    <li className={styles.secA}>Instead of worrying about the road, relax in our chauffeur-driven cabs on your next vacation. With a presence in over 2000 cities across India, we're here to take you wherever your heart desires with our car rental services.</li>

                    <li className={styles.secA}>
