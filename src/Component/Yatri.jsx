...
import styles from '../styles/Yatri.module.css'
const Yatri = () => {
    return (
        <div className={styles.main}>
            <div className={styles.first}>Why Choose Yatri Car Rental?</div>
            <div className={styles.second}>
                <ul>
                    ...
                    <li><b>Service You Can Trust</b> - At Yatri Car Rental, we are dedicated to providing dependable services in INDIA. We guarantee that we won't cancel any bookings without advance notification, and our rental cars are meticulously maintained to ensure a seamless and stress-free journey for our clients.</li>
                    ...
                    <li>
                        ...
                        <b>Extensive Industry Experience</b> - With over 10 years of industry expertise, Yatri Car Rental is your go-to choice for premium car hire services in Lucknow, Uttar Pradesh.
                    </li>
                    <li>
